...
describe("translating bg-BG string: Invalid procedure call or argument", function () {
	var translation;
...
describe("translating bg-BG string: Overflow", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Out of memory", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Subscript out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: This array is fixed or temporarily locked", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Division by zero", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Type mismatch", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Out of string space", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't perform requested operation", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Out of stack space", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Sub or Function not defined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Error in loading DLL", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Internal error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Bad file name or number", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: File not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Bad file mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: File already open", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Device I/O error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: File already exists", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Disk full", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Input past end of file", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Too many files", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Device unavailable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Permission denied", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Disk not ready", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't rename with different drive", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Path/File access error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Path not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object variable or With block variable not set", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: For loop not initialized", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid use of Null", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't create necessary temporary file", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object required", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Automation server can't create object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Class doesn't support Automation", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: File name or class name not found during Automation operation", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object doesn't support this property or method", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Automation error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object doesn't support this action", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object doesn't support named arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object doesn't support current locale setting", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Named argument not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Argument not optional", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Wrong number of arguments or invalid property assignment", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object not a collection", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Specified DLL function not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Variable uses an Automation type not supported in JavaScript", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The remote server machine does not exist or is unavailable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot assign to variable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object not safe for scripting", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object not safe for initializing", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object not safe for creating", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: An exception occurred", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Syntax error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected ':'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected identifier", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid number", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid character", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unterminated string constant", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unterminated comment", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'return' statement outside of function", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't have 'break' outside of loop", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't have 'continue' outside of loop", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected hexadecimal digit", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected 'while'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Label redefined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Label not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'default' can only appear once in a 'switch' statement", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected identifier, string or number", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected '@end'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Conditional compilation is turned off", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected constant", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected 'catch'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected 'var'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'throw' must be followed by an expression on the same source line", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'with' statements are not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Duplicate formal parameter names not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Octal numeric literals and escape characters not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid usage of 'eval' in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid usage of 'arguments' in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Calling delete on expression not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Multiple definitions of a property not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: In strict mode, function declarations cannot be nested inside a statement or block. They may only appear at the top level or directly inside a function body.", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The use of a keyword for an identifier is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The use of a future reserved word for an identifier is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The use of a future reserved word for an identifier is invalid. The identifier name is reserved in strict mode.", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Setter functions must have one argument", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: JavaScript compilation error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: JavaScript runtime error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unknown runtime error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot assign to 'this'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Number expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Function expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot assign to a function result", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot index object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: String expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Date object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid left-hand side in assignment", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Undefined identifier", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Boolean expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Can't execute code from a freed script", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object member expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: VBArray expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: JavaScript object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Enumerator object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Regular Expression object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Syntax error in regular expression", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unexpected quantifier", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Expected ']' in regular expression", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid range in character set", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Exception thrown and not caught", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Function does not have a valid prototype object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The URI to be encoded contains an invalid character", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The URI to be decoded is not a valid encoding", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The number of fractional digits is out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The precision is out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Array or arguments object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Array length must be a finite positive integer", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Array length must be assigned a finite positive number", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Array object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Circular reference in value argument not supported", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid replacer argument", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Argument list too large to apply", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Redeclaration of const property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object member not configurable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Variable undefined in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Accessing the 'caller' property of a function or arguments object is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Accessing the 'callee' property of an arguments object is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Assignment to read-only properties is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot create property for a non-extensible object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Property cannot have both accessors and a value", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'this' is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Date expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: RegExp object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid function argument", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid 'length' property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid Operand", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid property descriptor", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot define property: object is not extensible", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot redefine non-configurable property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot modify non-writable property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot modify property: 'length' is not writable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot define property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Typed array constructor argument is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'this' is not a typed array object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid offset/length when creating typed array", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid begin/end value in typed array subarray method", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid source in typed array set", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'this' is not a DataView object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid arguments in DataView", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: DataView operation access beyond specified buffer length", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: invalid function signature", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: invalid property signature", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: invalid input parameter type", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: invalid ouput parameter", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Accessing the 'arguments' property of a function is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Inspectable Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert argument to type 'char'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert argument to type 'GUID'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: IInspectable expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert object to struct: object missing expected property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unknown type", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Function called with too few arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Type is not constructible", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert value to PropertyValue: Type not supported by PropertyValue", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert value to IInspectable: Type not supported by IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert Date to Windows.Foundation.DateTime: value outside of valid range", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert value to Windows.Foundation.TimeSpan: value outside of valid range", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid access to already released Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot release already released Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'this' is not of the expected type", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Illegal length and size specified for the array", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: An unexpected failure occurred while trying to obtain metadata information", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Status is 'error', but getResults did not return an error", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Missing or invalid status parameter passed to completed handler", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Missing or invalid sender parameter passed to completed handler", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Infinity", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Object doesn't support property or method 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Argument to the function 'MyDynamicTestString' is not optional", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a number", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a function", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not an indexable object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a string", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a date object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is null or not an object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot assign to 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a boolean", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot delete 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a VBArray", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not an enumerator object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' is not a regular expression object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString is not an Array or arguments object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString is not an Array object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' attribute on the property descriptor cannot be set to 'true' on this object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'MyDynamicTestString' attribute on the property descriptor cannot be set to 'false' on this object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Redeclaration of const 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Calling delete on 'MyDynamicTestString' is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unable to set property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unable to get property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unable to delete property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Unable to access property 'MyDynamicTestString': type 'VarDate' does not support user-defined properties", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The value of the property 'MyDynamicTestString' is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The value of the property 'MyDynamicTestString' is null or undefined, not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not an Object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a String object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a Boolean object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a Date object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a Number object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a VBArray object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not an Enumerator object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not a RegExp object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: invalid argument", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is not an Object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is not a VBArray object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument is not an Object and is not null", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: argument does not have a valid 'length' property", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: Array or arguments object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid operand to 'MyDynamicTestString': Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid operand to 'MyDynamicTestString': Function expected", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Invalid descriptor for property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot define property 'MyDynamicTestString': object is not extensible", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot redefine non-configurable property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot modify non-writable property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot modify property 'MyDynamicTestString': 'length' is not writable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Cannot define property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Required argument MyDynamicTestString in DataView method is not specified", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: DataView constructor argument MyDynamicTestString is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The function 'MyDynamicTestString' has an invalid signature and cannot be called", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The property 'MyDynamicTestString' has an invalid signature and cannot be accessed", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The runtimeclass MyDynamicTestString that has Windows.Foundation.IPropertyValue as default interface is not supported as input parameter type", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The object with interface Windows.Foundation.IPropertyValue that has runtimeclass name MyDynamicTestString is not supported as out parameter", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: 'this' is not an Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: could not convert argument to type 'char'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: could not convert argument to type 'GUID'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: could not convert return value to IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert object to struct: object missing expected property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Type 'MyDynamicTestString' not found", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: function called with too few arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: type is not constructible", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert value to PropertyValue: MyDynamicTestString not supported by PropertyValue", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: Could not convert value to IInspectable: MyDynamicTestString not supported by IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: The Inspectable object 'this' is released and cannot be accessed", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: 'this' is not of expected type: MyDynamicTestString", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: MyDynamicTestString: an unexpected failure occurred while trying to obtain metadata information", function () {
	var translation;
	before(function (done) {
...
describe("translating bg-BG string: The specified date is not available in the current locale's calendar", function () {
	var translation;
	before(function (done) {
