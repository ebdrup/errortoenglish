...
describe("translating sr-Latn-CS string: Invalid procedure call or argument", function () {
	var translation;
...
describe("translating sr-Latn-CS string: Overflow", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Out of memory", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Subscript out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: This array is fixed or temporarily locked", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Division by zero", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Type mismatch", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Out of string space", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't perform requested operation", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Out of stack space", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Sub or Function not defined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Error in loading DLL", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Internal error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Bad file name or number", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: File not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Bad file mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: File already open", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Device I/O error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: File already exists", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Disk full", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Input past end of file", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Too many files", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Device unavailable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Permission denied", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Disk not ready", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't rename with different drive", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Path/File access error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Path not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object variable or With block variable not set", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: For loop not initialized", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid use of Null", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't create necessary temporary file", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object required", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Automation server can't create object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Class doesn't support Automation", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: File name or class name not found during Automation operation", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object doesn't support this property or method", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Automation error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object doesn't support this action", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object doesn't support named arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object doesn't support current locale setting", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Named argument not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Argument not optional", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Wrong number of arguments or invalid property assignment", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object not a collection", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Specified DLL function not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Variable uses an Automation type not supported in JavaScript", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The remote server machine does not exist or is unavailable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot assign to variable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object not safe for scripting", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object not safe for initializing", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object not safe for creating", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: An exception occurred", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Syntax error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected ':'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected identifier", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid number", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid character", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unterminated string constant", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unterminated comment", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'return' statement outside of function", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't have 'break' outside of loop", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't have 'continue' outside of loop", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected hexadecimal digit", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected 'while'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Label redefined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Label not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'default' can only appear once in a 'switch' statement", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected identifier, string or number", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected '@end'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Conditional compilation is turned off", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected constant", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected 'catch'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected 'var'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'throw' must be followed by an expression on the same source line", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'with' statements are not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Duplicate formal parameter names not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Octal numeric literals and escape characters not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid usage of 'eval' in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid usage of 'arguments' in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Calling delete on expression not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Multiple definitions of a property not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: In strict mode, function declarations cannot be nested inside a statement or block. They may only appear at the top level or directly inside a function body.", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The use of a keyword for an identifier is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The use of a future reserved word for an identifier is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The use of a future reserved word for an identifier is invalid. The identifier name is reserved in strict mode.", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Setter functions must have one argument", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: JavaScript compilation error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: JavaScript runtime error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unknown runtime error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot assign to 'this'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Number expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Function expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot assign to a function result", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot index object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: String expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Date object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid left-hand side in assignment", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Undefined identifier", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Boolean expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Can't execute code from a freed script", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object member expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: VBArray expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: JavaScript object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Enumerator object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Regular Expression object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Syntax error in regular expression", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unexpected quantifier", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Expected ']' in regular expression", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid range in character set", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Exception thrown and not caught", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Function does not have a valid prototype object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The URI to be encoded contains an invalid character", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The URI to be decoded is not a valid encoding", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The number of fractional digits is out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The precision is out of range", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Array or arguments object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Array length must be a finite positive integer", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Array length must be assigned a finite positive number", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Array object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Circular reference in value argument not supported", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid replacer argument", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Argument list too large to apply", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Redeclaration of const property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object member not configurable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Variable undefined in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Accessing the 'caller' property of a function or arguments object is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Accessing the 'callee' property of an arguments object is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Assignment to read-only properties is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot create property for a non-extensible object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Property cannot have both accessors and a value", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'this' is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Date expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: RegExp object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid function argument", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid 'length' property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid Operand", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid property descriptor", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot define property: object is not extensible", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot redefine non-configurable property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot modify non-writable property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot modify property: 'length' is not writable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot define property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Typed array constructor argument is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'this' is not a typed array object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid offset/length when creating typed array", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid begin/end value in typed array subarray method", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid source in typed array set", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'this' is not a DataView object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid arguments in DataView", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: DataView operation access beyond specified buffer length", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: invalid function signature", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: invalid property signature", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: invalid input parameter type", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: invalid ouput parameter", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Accessing the 'arguments' property of a function is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Inspectable Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert argument to type 'char'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert argument to type 'GUID'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: IInspectable expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert object to struct: object missing expected property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unknown type", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Function called with too few arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Type is not constructible", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert value to PropertyValue: Type not supported by PropertyValue", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert value to IInspectable: Type not supported by IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert Date to Windows.Foundation.DateTime: value outside of valid range", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert value to Windows.Foundation.TimeSpan: value outside of valid range", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid access to already released Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot release already released Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'this' is not of the expected type", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Illegal length and size specified for the array", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: An unexpected failure occurred while trying to obtain metadata information", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Status is 'error', but getResults did not return an error", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Missing or invalid status parameter passed to completed handler", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Missing or invalid sender parameter passed to completed handler", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Infinity", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Object doesn't support property or method 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Argument to the function 'MyDynamicTestString' is not optional", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a number", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a function", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not an indexable object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a string", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a date object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is null or not an object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot assign to 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a boolean", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot delete 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a VBArray", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not an enumerator object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' is not a regular expression object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString is not an Array or arguments object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString is not an Array object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' attribute on the property descriptor cannot be set to 'true' on this object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'MyDynamicTestString' attribute on the property descriptor cannot be set to 'false' on this object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Redeclaration of const 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Calling delete on 'MyDynamicTestString' is not allowed in strict mode", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unable to set property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unable to get property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unable to delete property 'MyDynamicTestString' of undefined or null reference", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Unable to access property 'MyDynamicTestString': type 'VarDate' does not support user-defined properties", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The value of the property 'MyDynamicTestString' is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The value of the property 'MyDynamicTestString' is null or undefined, not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not an Object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a String object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a Boolean object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a Date object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a Number object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a VBArray object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not an Enumerator object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not a RegExp object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: invalid argument", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is not an Object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is not a JavaScript object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is not a Function object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is not a VBArray object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is null or undefined", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument is not an Object and is not null", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: argument does not have a valid 'length' property", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: Array or arguments object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid operand to 'MyDynamicTestString': Object expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid operand to 'MyDynamicTestString': Function expected", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Invalid descriptor for property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot define property 'MyDynamicTestString': object is not extensible", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot redefine non-configurable property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot modify non-writable property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot modify property 'MyDynamicTestString': 'length' is not writable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Cannot define property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Required argument MyDynamicTestString in DataView method is not specified", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: DataView constructor argument MyDynamicTestString is invalid", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The function 'MyDynamicTestString' has an invalid signature and cannot be called", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The property 'MyDynamicTestString' has an invalid signature and cannot be accessed", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The runtimeclass MyDynamicTestString that has Windows.Foundation.IPropertyValue as default interface is not supported as input parameter type", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The object with interface Windows.Foundation.IPropertyValue that has runtimeclass name MyDynamicTestString is not supported as out parameter", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: 'this' is not an Inspectable Object", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: could not convert argument to type 'char'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: could not convert argument to type 'GUID'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: could not convert return value to IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert object to struct: object missing expected property 'MyDynamicTestString'", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Type 'MyDynamicTestString' not found", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: function called with too few arguments", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: type is not constructible", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert value to PropertyValue: MyDynamicTestString not supported by PropertyValue", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: Could not convert value to IInspectable: MyDynamicTestString not supported by IInspectable", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: The Inspectable object 'this' is released and cannot be accessed", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: 'this' is not of expected type: MyDynamicTestString", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: MyDynamicTestString: an unexpected failure occurred while trying to obtain metadata information", function () {
	var translation;
	before(function (done) {
...
describe("translating sr-Latn-CS string: The specified date is not available in the current locale's calendar", function () {
	var translation;
	before(function (done) {
